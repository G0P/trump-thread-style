...
var background_img = [
  "url('https://i.imgur.com/QAxc9hZ.jpg')",
  "url('https://i.imgur.com/LUbljG8.jpg')",
  "url('https://i.imgur.com/DnnVD4W.jpg')",
  "url('https://i.imgur.com/N495BdW.jpg')",
  "url('https://i.imgur.com/JUdngfC.jpg')",
  "url('https://i.imgur.com/Bs6D5ll.jpg')",
  "url('https://i.imgur.com/KEXVj9D.jpg')",
  "url('https://i.imgur.com/amzfXlD.jpg')",
  "url('https://i.imgur.com/ocjZBD6.jpg')",
...
if(op.getElementsByClassName("subject")[0].textContent.indexOf("TRUMP GENERAL") >= 0)
{
  // background properties
  var s = document.body.style;
  s.backgroundColor       = "#1d1f21";
  s.backgroundImage       = background_img[Math.floor(Math.random() * (background_img.length - 1))];
